...
if WITH_MULTIMODAL:
    ...
    register_multimodal_placeholder([
        'BLIP2Captioner', 'BLIP2Retriever', 'BLIP2Retriever', 'BLIP2VQAModel',
        'BLIPCaptioner', 'BLIPNLVR', 'BLIPRetriever', 'BlipGroundingModel',
        'BlipVQAModel', 'BlipVQAModel', 'Flamingo', 'OFA'
    ], MODELS)
